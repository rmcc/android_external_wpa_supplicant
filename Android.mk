...
AR6ROOT=$(LOCAL_PATH)/ar6000
L_CFLAGS += -I$(AR6ROOT)/include
L_CFLAGS += -I$(AR6ROOT)/host/include
L_CFLAGS += -I$(AR6ROOT)/host/os/linux/include
L_CFLAGS += -I$(AR6ROOT)/host/wlan/include
L_CFLAGS += -DLINUX

L_CFLAGS += -DCONFIG_DRIVER_AR6000
OBJS_d += driver_ar6000.c
CONFIG_WIRELESS_EXTENSION=y
endif
